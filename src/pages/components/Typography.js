          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                more control is needed, check out the <Link to={`/components/util-text`}>textual utility classes.</Link>
              </p>
            </BlockDes>
          </BlockHeadContent>
        </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use the <Link to={`/components/util-text`}>text utitlity classes</Link> to customize the heading text
                further.
              </p>
            </BlockHeadContent>
          </BlockHead>
