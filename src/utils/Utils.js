...
export const dateFormatter = (date, reverse, string) => {
  ...
  reverse ? (date = dateformat[2] + '-' + dateformat[0] + '-' + dateformat[1]) : (date = dateformat[1] + '-' + dateformat[2] + '-' + dateformat[0]);
...
export const RedirectAs404 = ({ location }) => <Redirect to={Object.assign({}, location, { state: { is404: true } })} />;
